          ...
          <div className="flex items-start gap-4">
            <div className="relative w-20 h-20 rounded-lg bg-muted flex-shrink-0 overflow-hidden">
              ...
              {showBadge && isSelected && (
                <Badge variant="default" className="absolute bottom-1 left-1/2 transform -translate-x-1/2 text-xs px-2 py-0.5 bg-amber-400 text-primary hover:bg-amber-400 shadow-sm">
                  My Rep
                </Badge>
              )}
            </div>
