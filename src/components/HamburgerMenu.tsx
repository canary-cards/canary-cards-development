    ...
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
         <Button
           variant="ghost"
           size="icon"
           className="relative z-50 h-10 w-10 focus:outline-none focus:ring-2 focus:ring-[--ring] focus:ring-offset-2 hover-safe:bg-primary/10 hover-safe:text-primary hover-primary-tint hover-primary-text"
