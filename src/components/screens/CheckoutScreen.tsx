  ...
  return <>
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 pb-24 max-w-2xl">
          ...
          {/* Single Voice Card */}
          <div className={`rounded-lg border p-4 transition-all mb-6 bg-card cursor-pointer relative ${selection === 'rep-only' ? 'ring-2 ring-primary bg-primary/5 border-primary shadow-md' : 'border-border hover:border-primary/50 hover:shadow-md'}`} onClick={() => handleSelectionChange('rep-only')}>
          ...
          <div className={`rounded-lg border p-4 transition-all mb-6 bg-card cursor-pointer relative shadow-lg hover:shadow-xl ${selection === 'all-three' ? 'ring-2 ring-primary bg-primary/5 border-primary shadow-xl' : 'border-border hover:border-primary/50'}`} onClick={() => handleSelectionChange('all-three')}>
            {/* Save $3 Badge */}
          ...
          {/* Mix & Match Card */}
          <div className={`rounded-lg border p-4 transition-all mb-6 bg-card cursor-pointer ${selection === 'custom' ? 'ring-2 ring-primary bg-primary/5 border-primary shadow-md' : 'border-border hover:border-primary/50 hover:shadow-md'}`} onClick={() => setShowMixMatch(true)}>
