  ...
  return <>
      <div className="min-h-screen bg-background">
        <div className="container mx-auto px-4 pb-24 max-w-2xl">
          ...
          {/* Single Voice Card */}
          <div className={`rounded-lg border p-4 transition-all mb-6 bg-card cursor-pointer relative ${selection === 'rep-only' ? 'border-primary' : 'border-border hover:border-primary/50'}`} onClick={() => handleSelectionChange('rep-only')}>
          ...
          <div className={`rounded-lg border-2 border-primary shadow-md p-4 transition-all mb-6 bg-card cursor-pointer relative ${selection === 'all-three' ? 'shadow-lg' : 'hover:shadow-lg'}`} onClick={() => handleSelectionChange('all-three')}>
            {/* Save $3 Badge */}
          ...
          {/* Mix & Match Card */}
          <div className={`rounded-lg border p-4 transition-all mb-6 bg-card cursor-pointer ${selection === 'custom' ? 'border-primary' : 'border-border hover:border-primary/50'}`} onClick={() => setShowMixMatch(true)}>
